...
const BOARD = [
  ...
  { i: 10, type: "jail",     name: "Тюрьма",         sub: "Просто в гостях" },
  { i: 11, type: "city",     name: "Стамбул",        price: 140, group: "pink" },
  { i: 12, type: "utility",  name: "Мировая энергосеть", price: 150 },
  ...
  { i: 20, type: "parking",  name: "Отдых",          sub: "Бесплатная стоянка" },
  ...
  { i: 28, type: "utility",  name: "Глобальная сеть воды", price: 150 },
  { i: 29, type: "city",     name: "Стокгольм",      price: 280, group: "yellow" },
  { i: 30, type: "gotojail", name: "В тюрьму",       sub: "Отправляйся в тюрьму" },
  ...
  { i: 35, type: "airport",  name: "Дубай Интл",     price: 200 },
